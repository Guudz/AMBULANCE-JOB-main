...
function OpenPharmacyMenu()
	...
	ESX.UI.Menu.Open('default', GetCurrentResourceName(), 'pharmacy', {
		...
		elements = {
			...
			{label = _U('pharmacy_take', _U('stretcher2')), value = 'stretcher2'},
			{label = _U('pharmacy_take', _U('stretcher3')), value = 'stretcher3'},		
			{label = _U('pharmacy_take', _U('stretcher5')), value = 'stretcher5'}
