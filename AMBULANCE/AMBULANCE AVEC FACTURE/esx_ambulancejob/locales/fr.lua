Locales['fr'] = {
  ...
  ['actions_prompt'] = 'Appuyez sur ~INPUT_CONTEXT~ accéder au vestiaire ~y~Ambulance~s~.',
  ...
  ['bandage'] = 'bandage',
  ['stretcher'] = 'Brancard',
  ['stretcher2'] = 'Brancard Covid',
  ['stretcher3'] = 'Brancard morgue',
  ['stretcher4'] = 'Tente de décontamination',
  ['stretcher5'] = 'Brancard transport',
